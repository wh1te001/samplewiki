        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WikiLink = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Revisions_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Artworks_Samples_SampleId",
                        column: x => x.SampleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artworks_SampleId",
                table: "Artworks",
                column: "SampleId");

            migrationBuilder.CreateIndex(
                name: "IX_Revisions_EntityName_EntityId",
                table: "Revisions",
                columns: new[] { "EntityName", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Revisions_TrackId",
                table: "Revisions",
                column: "TrackId");
